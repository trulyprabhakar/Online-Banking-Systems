                ...
                %>
                    ...
                    <div class="">
                        <nav class="navbar navbar-expand-lg navbar-light bg-info">
                            ...
                            <div class="">
                                <a class="navbar-brand" href="withrow.jsp">Withdraw</a>
                            </div>
                            <div class="">
                    ...
                    <div class="">
                        <div class="container bg-dark mt-5">
                            <h5 class="text-white text-center">Deposite Amount in Own Bnak Account</h5>        
                        </div>
                    </div>    
                    <div class="row pt-3">
                    ...
                    <footer class="pt-4">
                        <div class="text-center bg-info">
                            <h6 class="py-2">Copyright @Technical Minds</h6>
                        </div>
                    </footer>
                <%
            }
