                ...
                <div class="row pt-3">
                    ...
                    <div class="col-lg-4 col-md-4 col-xl-4 col-sm-6 col-8">
                        <form action="check_balance_data.jsp" method="POST">
                            ...
                            <div class="mb-2">
                                <p class="">If you want to Deposite then <a href="deposit.jsp">Click here</a></p>
                            </div>
                            <div class="mb-2">
                                <p class="">For Withdrow the Amount to your Account <a href="withdrow.jsp">Click here</a></p>
                            </div>
                        </form>
                    </div>
                    <div class="col-lg-4 col-md-4 col-xl-4 col-sm-3 col-2"></div>
