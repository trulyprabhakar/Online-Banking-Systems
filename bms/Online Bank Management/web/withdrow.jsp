...
<html>
    <head>
        ...
        <title>Withdrow amount in own bank</title>
                ...
                %>
                    ...
                    <div class="">
                        <div class="container bg-dark mt-5">
                            <h5 class="text-white text-center">Withdwar Amount in Own Bnak Account</h5>        
                        </div>
                    </div>    
                    <div class="row pt-3">
                        <div class="col-lg-4 col-md-4 col-xl-4 col-sm-3 col-2"></div>
                        <div class="col-lg-4 col-md-4 col-xl-4 col-sm-6 col-8">
                            <form action="withdrow_email1.jsp" method="POST">
                                <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    <h5 class="text-center">How much Amount want to withrow</h5>
                                    <input type="text" name="money" class="form-control" placeholder="1000 Rs.">
                                </div>
                                <div class="text-center">
                                    <button type="submit" name="button" class="btn btn-primary">Withraw</button>
                                </div>
                            </form>
                        </div>
                        <div class="col-lg-4 col-md-4 col-xl-4 col-sm-3 col-2"></div>
